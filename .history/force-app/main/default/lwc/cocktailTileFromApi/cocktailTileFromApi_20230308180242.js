...
export default class CocktailTileFromApi extends LightningElement {
  ...
  createCocktail() {
    ...
    createRecord(recordInput)
      .then((cocktail) => {
        ...
        this.handleRecordUploaded = true;
        console.log(this.handleRecordUploaded);
  ...
  get isCreateDisabled() {
    let showRecord;
    if(this.handleRecordUploaded === false){
     showRecord = this.cocktail.isExisting__c;
    }
    else{
      showRecord = false;
    }
