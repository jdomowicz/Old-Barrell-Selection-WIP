...
export default class CocktailTileFromApi extends LightningElement {
  ...
  createCocktail() {
    ...
    fields[Ingredient2.fieldApiName] = this.cocktail.Measure1__c;
    fields[Ingredient3.fieldApiName] = this.cocktail.Measure1__c;
    fields[Ingredient4.fieldApiName] = this.cocktail.Measure1__c;
    fields[Ingredient5.fieldApiName] = this.cocktail.Measure1__c;
