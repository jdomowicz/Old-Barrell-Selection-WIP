...
export default class CocktailTileFromApi extends LightningElement {
  ...
  createCocktail(){
    ...
    fields[NAME_Ingredient1FIELD.fieldApiName] = this.cocktail.Name;
    Ingredient1.fieldApiName=cocktail.Ingredient1__c,
      Ingredient2.fieldApiName=cocktail.Ingredient2__c,
      Ingredient3.fieldApiName=cocktail.Ingredient3__c,
      PictureURL__c.fieldApiName=cocktail.PictureURL__c,
      ExternalId.fieldApiName=cocktail.Drink_External_Id__c
