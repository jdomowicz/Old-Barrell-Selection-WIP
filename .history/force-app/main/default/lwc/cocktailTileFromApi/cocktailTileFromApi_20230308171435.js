...
export default class CocktailTileFromApi extends LightningElement {
  ...
  createCocktail() {
    ...
    fields[Ingredient2.fieldApiName] = this.cocktail.Measure2__c;
    fields[Ingredient3.fieldApiName] = this.cocktail.Measure3__c;
    fields[Ingredient4.fieldApiName] = this.cocktail.Measure4__c;
    fields[Ingredient5.fieldApiName] = this.cocktail.Measure5__c;
