...
export default class CocktailTileFromApi extends LightningElement {
  ...
  createCocktail() {
    ...
    createRecord(recordInput)
      .then((cocktail) => {
        ...
        this._isButtomVisiable = false;
        console.log('is button visible variable ' + this.isButtomVisiable);
        this.dispatchEvent(
          new ShowToastEvent({
            title: "Success",
  ...
  get isCreateDisabled() {
    return this._isButtomVisiable;
  }
    set isCreateDisabled(value) {

    this._isButtomVisiable = this.cocktail.isExisting__c;
