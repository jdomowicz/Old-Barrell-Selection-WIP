...
export default class CocktailTileFromApi extends NavigationMixin(LightningElement) {
  @api cocktail;
  Ing1;
  cocktailId;
  ...
  createCocktail() {
    ...
    createRecord(recordInput)
      .then((cocktail) => {
        ...
        console.log(this.RecordUploaded);
  ...
  get cocktailIdg() {
    return `${this.cocktail.Id} - ${this.cocktail.Drink_External_Id__c}`;
  }
