...
export default class CocktailDetails extends LightningElement {
  ...
  get ing3() {
    return getFieldValue(this.recDetail.data, Ingredient3);
  }
  get ing4() {
    return getFieldValue(this.recDetail.data, Ingredient4);
  }
  get ing5() {
    return getFieldValue(this.recDetail.data, Ingredient5);
  }
}
