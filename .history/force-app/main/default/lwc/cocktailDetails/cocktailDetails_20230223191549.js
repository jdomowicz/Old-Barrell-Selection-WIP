...
export default class CocktailDetails extends LightningElement {
  ...
  @api
  get ing1() {
      concatIngr(getFieldValue(this.recDetail, measure1),getFieldValue(this.recDetail, Ingredient1))
    
    getFieldValue(this.recDetail, measure1) + ' ' +  getFieldValue(this.recDetail, Ingredient1);
  }
