...
import Instructions__c from '@salesforce/schema/Coctail__c.No_Ingredients__c ';
...
export default class CocktailDetails extends LightningElement {
   ...
   @wire(getRecord, { recordid: '$recordid', fields:[NAME_FIELD,Ingredient1,Ingredient2,Ingredient3,Ingredient4,Ingredient5] })
   getRecordDetails;
