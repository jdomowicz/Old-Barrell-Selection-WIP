...
export default class CocktailDetails extends LightningElement {
   ...
   @api recordid;
   const fields = [Ingredient1,Ingredient2,Ingredient3,Ingredient4,Ingredient5];


   @wire(getRecord, { recordid: '$recordid', fields:[Ingredient1,Ingredient2,Ingredient3,Ingredient4,Ingredient5] })
   getRecordDetails;
