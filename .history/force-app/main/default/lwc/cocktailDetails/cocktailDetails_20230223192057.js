...
export default class CocktailDetails extends LightningElement {
  ...
  return this.concatIngr(getFieldValue(this.recDetail, measure1),getFieldValue(this.recDetail, Ingredient1))

  }

  get ing2() {

      return this.concatIngr(getFieldValue(this.recDetail, measure2),getFieldValue(this.recDetail, Ingredient2))
  }
  get ing3() {

      return this.concatIngr(getFieldValue(this.recDetail, measure3),getFieldValue(this.recDetail, Ingredient3))
  }

  get ing4() {

     return this.concatIngr(getFieldValue(this.recDetail, measure4),getFieldValue(this.recDetail, Ingredient4))
  }
  get ing5() {

      return this.concatIngr(getFieldValue(this.recDetail, measure5),getFieldValue(this.recDetail, Ingredient1))
  }
