...
export default class CocktailDetails extends LightningElement {
   ...
   @wire(getRecord, { recordid: 'a001x00000DLXt8AAH', fields:[NAME_FIELD,Ingredient1,Ingredient2,Ingredient3,Ingredient4,Ingredient5,Instructions__c,No_Ingredients__c] })
   getRecordDetails;
