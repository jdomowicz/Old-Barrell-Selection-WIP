...
const fields = [NAMEF,Ingredient1,Ingredient2,Ingredient3,Ingredient4,Ingredient5,Instructions__c,No_Ingredients__c];
export default class CocktailDetails extends LightningElement {
 ...
 get name() {
        return getFieldValue(this.recDetail.data, NAMEF);
    }
